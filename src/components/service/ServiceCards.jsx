    ...
    <article>
      ...
      >
        {activeServiceList.map((service) => {
          return (
            <section className="flex w-[340px] flex-col items-center gap-10 rounded-[50px] px-6 py-16 outline outline-1 outline-slate-400 duration-200 hover:-translate-y-2 hover:border-b-4 hover:border-primary hover:shadow-[0px_0px_12px_4px_rgba(0,0,0,0.3)] hover:shadow-slate-400">
              <div className="">
